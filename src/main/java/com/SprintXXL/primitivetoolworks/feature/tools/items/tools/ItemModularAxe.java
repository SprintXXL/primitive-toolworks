...
public class ItemModularAxe extends ItemAxe {

    private static final ToolType toolType = ModToolTypes.AXE;

    public ItemModularAxe(String name) {
    ...
    public String getItemStackDisplayName(ItemStack stack) {
        return ToolDisplayNameHelper.getDisplayName(stack, toolType, "Axe");
    }
    ...
    public void getSubItems(CreativeTabs tab, NonNullList<ItemStack> items) {
        ...
        items.add(ToolStackFactory.createDefaultTool(this, ModToolTypes.AXE));
    }
