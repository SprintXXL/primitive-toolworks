package com.SprintXXL.primitivetoolworks.feature.tables.stenciltable.tileentities;
...
public class TileEntityStencilTable extends TileEntity implements IInventory {
    ...
    @Override public String getName() { return "container_stencil_table"; }
