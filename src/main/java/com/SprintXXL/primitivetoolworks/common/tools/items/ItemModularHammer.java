...
import com.SprintXXL.primitivetoolworks.common.tools.aoe.AoeProfile;
import com.SprintXXL.primitivetoolworks.common.tools.aoe.IAoeTool;
import com.SprintXXL.primitivetoolworks.common.tools.helpers.ToolDamageHelper;
...
import static com.SprintXXL.primitivetoolworks.common.tools.helpers.ToolDamageHelper.isBroken;
...
public class ItemModularHammer extends ItemPickaxe implements IAoeTool {
    ...
    public String getItemStackDisplayName(ItemStack stack) {
        ...
        if (mainMaterial == null) {
            return "Modular Hammer";
        }

        return mainMaterial.getTitleDisplayName() + " Hammer";
    }
